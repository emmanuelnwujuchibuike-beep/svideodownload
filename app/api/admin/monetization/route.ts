...
const schema = z.object({
  ...
  */
  ...
  exoclickHistoryFeedLastWeekSnippet: z.string().max(4000).default(""),
  ...
  ambientSkipSeconds: z.number().int().min(0).max(60).default(5),
  ambientCooldownSeconds: z.number().int().min(0).max(3600).default(300),
  ...
  */
  hilltop: z
    .object({
      ...
      slotSource: z.record(z.string(), z.enum(["banner", "slider", "interstitial"])).default({}),
    })
