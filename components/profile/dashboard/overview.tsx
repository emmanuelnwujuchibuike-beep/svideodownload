...
export function StatsRow() {
  return (
    <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4">
      {STATS.map((s) => (
        <div key={s.label} className="flex items-start gap-3 rounded-2xl border border-border/70 bg-card p-4 shadow-sm">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-0.5 truncate text-lg font-extrabold tracking-tight">
              {s.value}
              {s.suffix ? <span className="text-sm font-semibold text-muted-foreground"> {s.suffix}</span> : null}
            </p>
  ...
  return (
    <div className={cn("rounded-3xl border border-border/70 bg-card p-5 shadow-card", className)}>
      <div className="flex items-center justify-between">
        <h2 className="text-base font-bold">Earnings Overview</h2>
        <SoonButton
      ...
      <p className="mt-3 text-2xl font-extrabold tracking-tight">₦245,000.50</p>
...
export function TopPerformerCard({ className }: { className?: string }) {
  return (
    <div className={cn("flex flex-col items-center rounded-3xl border border-border/70 bg-card p-5 text-center shadow-card", className)}>
      <h2 className="w-full text-left text-base font-bold">Top Performer</h2>
      ...
      <p className="text-3xl font-extrabold text-violet-600 dark:text-violet-400">3%</p>
