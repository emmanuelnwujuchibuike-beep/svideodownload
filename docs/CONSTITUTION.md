...
| Data platform | [data-domains.ts](../lib/platform/data-domains.ts) + [data-platform.ts](../lib/platform/data-platform.ts), admin "Data" section | ✅ every table owned by exactly one domain (enforced vs. migrations); storage strategies, lifecycle policies, Knowledge Fabric; vector/warehouse/archive/export honestly `planned` |
