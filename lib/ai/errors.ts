...
export type AiErrorCode =
  ...
  */
  ...
  /*
    ...
    reserved, so every one of these is "nothing was charged".
  */
  | "CR_ACTIVE_LIMIT"
  | "CR_DAILY_LIMIT"
  | "CR_BUSY"
  /* 0166 (multi-video): the member's open-jobs ceiling, one submission's size, and a queue that is switched off */
  | "CR_QUEUE_FULL"
  | "CR_BATCH_TOO_LARGE"
  | "CR_QUEUE_OFF"
