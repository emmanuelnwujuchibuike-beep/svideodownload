...
export const COMPONENTS: ComponentDef[] = [
  ...
  { id: "character-replace-entry", name: "Character Replace entry card", category: "surface", source: "features/ai/character-replace/character-replace-entry.tsx", status: "live", a11y: "One link carrying the accessible name; the NEW indicator is text, not colour alone; an unavailable tool renders the action as a static, non-focusable sentence.", motion: "Hover lift under motion-safe only." },
