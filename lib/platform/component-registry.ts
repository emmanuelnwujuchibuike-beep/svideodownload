...
export const COMPONENTS: ComponentDef[] = [
  ...
  /* ── Frenz AI (2026-09-07) ── */
  { id: "frenz-ai-header", name: "Frenz AI header", category: "navigation", source: "features/ai/frenz-ai-header.tsx", status: "live", a11y: "One h1 per screen; the crumb is a real link, and is a static span on the page it points at so it is never a dead tap.", motion: "None." },
  { id: "frenz-ai-tool-card", name: "Frenz AI tool card", category: "surface", source: "features/ai/frenz-ai-tool-card.tsx", status: "live", a11y: "An openable tool is one link carrying the accessible name; the inner pill is aria-hidden. An unbuilt tool is a plain div — not focusable, not pressable.", motion: "Hover lift + press scale under motion-safe only." },
  { id: "ai-clean-pro-badge", name: "Pro badge", category: "brand", source: "features/ai/ai-clean-pro-badge.tsx", status: "live", a11y: "Announces \"Pro feature\" rather than the three letters; never the only signal that something is paid.", motion: "Static — no shimmer, no glow." },
  { id: "ai-clean-upload", name: "Video drop zone", category: "input", source: "features/ai/ai-clean-upload.tsx", status: "live", a11y: "A real file input labelled by the panel; keyboard-operable through the input itself, with the focus ring painted on the panel via peer-focus-visible.", motion: "Colour + icon-scale on drag-over; 200ms, no transform under reduced-motion." },
  { id: "ai-clean-video-preview", name: "Video preview", category: "media", source: "features/ai/ai-clean-video-preview.tsx", status: "live", a11y: "Native controls; never autoplays; an unreadable file reports an error instead of showing a black box. Unmeasured facts render as an em-dash.", motion: "Fade-up entrance under motion-safe." },
  { id: "ai-clean-tutorial", name: "AI Clean tutorial", category: "overlay", source: "features/ai/ai-clean-tutorial.tsx", status: "live", a11y: "role=dialog + aria-modal, labelled by the step heading; Escape closes (and counts as skipped), Tab is trapped, focus returns to the opener, arrow keys step, and the step counter is announced politely.", motion: "Rise-and-fade entrance, crossfade between steps; reduced-motion removes both and the exit delay with them." },
