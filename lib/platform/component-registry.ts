...
export const COMPONENTS: ComponentDef[] = [
  ...
  /* ── Frenz AI (2026-09-07) ── */
  { id: "frenz-ai-crumb", name: "Frenz AI crumb", category: "navigation", source: "features/ai/frenz-ai-chrome.tsx", status: "live", a11y: "A nav landmark labelled Breadcrumb; the current tool carries aria-current=page and the plan seal renders only for a member who has one.", motion: "None." },
  { id: "frenz-ai-plan-badge", name: "Plan seal", category: "brand", source: "features/ai/frenz-ai-plan-badge.tsx", status: "live", a11y: "Announces the plan rather than the three letters; never the only signal that something is paid.", motion: "Static — no shimmer, no glow." },
  { id: "frenz-ai-explore", name: "Explore AI Studio", category: "surface", source: "features/ai/frenz-ai-explore.tsx", status: "live", a11y: "The grid is a list of doors, each one link (or, for a step chosen later, a button that shows where — announced through role=status); a switched-off tool is a non-focusable card with its sentence.", motion: "Hover lift under motion-safe only; the scroll to the scopes is instant under reduced motion." },
  { id: "frenz-ai-studio-card", name: "Frenz AI Studio card", category: "surface", source: "features/ai/frenz-ai-welcome.tsx", status: "live", a11y: "The card is a labelled region; the four capability groups are lists with their own names; Explore AI Studio is one link with its accessible name in text, and an unavailable studio renders the action as a static, non-focusable sentence.", motion: "The call to action's ambient light is a transform on a wider layer, 9 s per pass, paused with the environment on a hidden tab and stopped under reduced motion; hover lift under motion-safe only." },
  { id: "character-replace-media-picker", name: "Photo / video picker", category: "input", source: "features/ai/character-replace/media-picker.tsx", status: "live", a11y: "A real file input labelled by the panel; keyboard-operable through the input itself, with the focus ring painted on the panel via peer-focus-visible; validation is announced in a live region.", motion: "Colour + icon-scale on drag-over; 200ms, no transform under reduced-motion." },
  { id: "character-replace-stepper", name: "Workspace stepper", category: "navigation", source: "features/ai/character-replace/stepper.tsx", status: "live", a11y: "An ordered list with aria-current=step on the active step; completed steps are buttons that go back, future steps are static.", motion: "Width transition on the progress line; none under reduced-motion." },
  { id: "character-replace-pricing", name: "Estimated cost", category: "surface", source: "features/ai/character-replace/pricing-summary.tsx", status: "live", a11y: "A description list; the pending total is announced as text, never as a spinner alone.", motion: "None." },
