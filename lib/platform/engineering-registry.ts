...
export const ENGINEERING_ASSETS: EngineeringAsset[] = [
  ...
  { id: "globalization-platform-doc", name: "Globalization Platform", kind: "doc", source: "docs/GLOBALIZATION_PLATFORM.md", owner: "platform", description: "The unified localization, i18n, regionalization, multi-currency, timezone and localized-surface layer, mapped to real code with a teeth-backed registry; locale coverage is measured, never declared.", status: "live" },
  { id: "workspace-platform-doc", name: "Workspace Framework", kind: "doc", source: "docs/WORKSPACE_PLATFORM.md", owner: "platform", description: "The workspace kernel, Platform Shell, navigation engine, lifecycle, shared platform and plugin/AI extensibility, mapped to real code with a teeth-backed registry; honest that this is a modular monolith.", status: "live" },
