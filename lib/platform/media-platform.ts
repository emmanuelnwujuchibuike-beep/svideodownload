...
export const MEDIA_SERVICES: MediaService[] = [
  ...
  { id: "extraction", name: "Extraction Pipeline", source: "server/extractors/index.ts", status: "live", capability: "Source extraction across 12 platforms (yt-dlp + Apify + direct HTTP) with a quality ladder." },
