...
export const REGISTRIES: RegistryDef[] = [
  ...
  { id: "localization", name: "Localization Registry", governs: "Locales and the translation catalogue; coverage is measured.", source: "lib/i18n/locales.ts", status: "live", note: "The locale + catalogue source of truth. The platform-level map of every localization service, regional format, currency/timezone capability and localized surface is the Globalization Platform Registry below." },
  { id: "globalization-platform", name: "Globalization Platform Registry", governs: "The Enterprise Globalization Platform mapped: locales, localization/translation/formatting services, regional formats, multi-currency + timezone capabilities, localized surfaces and the AI layer.", source: "lib/platform/globalization-platform.ts", status: "live", note: "A catalogue over what EXISTS (locale registry with derived availability + Accept-Language negotiation, typed UI-string catalogue with per-key fallback and measured coverage, Intl formatting, honest hreflang, the export/import pipeline). Content translation (0086 schema, unread), true per-user timezones, multi-currency/FX, localized native/downloader/messaging surfaces and the whole AI layer are honestly planned — docs/GLOBALIZATION_PLATFORM.md." },
  { id: "search", name: "Search Registry", governs: "The cross-surface content search index.", source: "lib/search/index.ts", status: "live", note: "The build-time content corpus. The platform-level map of every index, ranking signal, SEO asset and discovery surface is the Search & Discovery Registry below." },
  { id: "search-platform", name: "Search & Discovery Registry", governs: "The Enterprise Search Platform mapped: searchable entities, indexes, ranking signals, SEO/AI-discovery assets, discovery surfaces and search types.", source: "lib/platform/search-platform.ts", status: "live", note: "A catalogue over what EXISTS (content index, social search, command gateway, discovery feed, Universal Entity + Schema registries, sitemap/robots/JSON-LD). Semantic/vector, media-search and the sitemap-index/llms.txt are honestly planned — docs/DISCOVERY_PLATFORM_RFC.md." },
  { id: "media-platform", name: "Media Registry", governs: "The Enterprise Media Platform mapped: media services, storage tiers, pipeline stages, delivery, media AI and observability, plus the supported-media taxonomy.", source: "lib/platform/media-platform.ts", status: "live", note: "A catalogue over what EXISTS (Cloudflare Stream ABR/HLS + captions, R2 + presigned upload + immutable CDN caching, the transcode worker, posters/waveforms, playback QoE + health probes). Background removal/upscaling/detection, cold archival, hash dedupe and 3D/AR/VR are honestly planned — docs/MEDIA_PLATFORM.md." },
  ...
  { id: "notifications", name: "Notification Type Registry", governs: "Every notification type, its category, grouping and badge rule.", source: "lib/platform/notifications-registry.ts", status: "live", note: "The type catalogue. The platform-level map of channels, sources, delivery, preferences and observability is the Notification Platform Registry below." },
  { id: "notification-platform", name: "Notification Platform Registry", governs: "The Enterprise Notification Platform mapped: services, channels, sources, real-time + smart delivery, preferences and the AI layer.", source: "lib/platform/notification-platform.ts", status: "live", note: "A catalogue over what EXISTS (VAPID Web/PWA push, smart per-preference delivery, quiet hours, digest, broadcasts, delivery analytics). SMS/native push/live-activity, a versioned template service, and the AI stack are honestly planned — docs/NOTIFICATION_PLATFORM.md." },
  { id: "commerce-platform", name: "Commerce Registry", governs: "The Enterprise Commerce Platform mapped: services, commerce types, payment capabilities, subscription tiers, billing/promotions and the AI layer.", source: "lib/platform/commerce-platform.ts", status: "live", note: "A catalogue over what EXISTS (Paystack subscriptions + checkout/webhook/billing-portal, plan/pricing, revenue decision engine, ads/affiliates, API billing, revenue analytics). Marketplace, creator payouts, invoices, refund workflows, promotions and the fraud/AI layer are honestly planned — docs/COMMERCE_PLATFORM.md." },
