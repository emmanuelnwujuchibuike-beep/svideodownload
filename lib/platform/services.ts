...
export const SERVICES: ServiceDef[] = [
  ...
  { id: "quality", name: "Quality Gateway", capability: "The gates + certifications a change clears before it ships.", source: "lib/platform/certification.ts", status: "live", note: "Enforced by CI (typecheck/lint/test/build) + the governance manifest; certifications computed from the gates." },
  { id: "release-governance", name: "Release Governance", capability: "Progressive rollout, kill switches, measured bets, rollback.", source: "lib/platform/flags.ts", status: "partial", note: "Feature flags + experiments live in-repo; canary/blue-green/preview envs are Vercel deploy-level, not in-repo code." },
