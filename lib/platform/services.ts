...
export const SERVICES: ServiceDef[] = [
  ...
  { id: "events-bus", name: "Event Gateway (bus)", capability: "Typed publish/subscribe for cross-module reactions.", source: "", status: "planned", note: "Deferred by design — one publisher/one consumer is a function call (CONSTITUTION Article VI). Build when a real 2nd consumer exists." },
