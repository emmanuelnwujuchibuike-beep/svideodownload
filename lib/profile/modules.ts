...
export const PROFILE_MODULES: ModuleSpec[] = [
  ...
  /* ───────────────────── Declared for later ─────────────────── */
  {
    ...
    types: "all",
    status: "planned",
    needs: "a pinning store — posts can't yet be pinned to a profile",
  },
  {
    key: "memberships",
    label: "Memberships",
    blurb: "Paid tiers your audience can subscribe to.",
    icon: "Crown",
    tint: "amber",
    types: ["creator", "business", "organization"],
    status: "planned",
    needs: "recurring creator billing — the commerce platform bills one-off payments today",
  },
  {
    key: "events",
    label: "Events",
    ...
    status: "planned",
    needs: "an events table with RSVPs",
  },
  {
    key: "reviews",
    label: "Reviews",
    blurb: "What customers say, from verified purchases.",
    icon: "Star",
    tint: "amber",
    types: ["business", "organization", "professional"],
    status: "planned",
    needs: "verified-purchase reviews — inventing ratings would be fabrication",
  },
  {
    key: "team",
    label: "Team",
    blurb: "The people behind this profile.",
    icon: "Users",
    tint: "cyan",
    types: ["business", "organization", "community", "government", "education"],
    status: "planned",
    needs: "multi-admin profiles — one profile has exactly one owner today",
  },
  {
    key: "repositories",
    label: "Repositories",
    blurb: "Your open-source work, synced from a git host.",
    icon: "GitBranch",
    tint: "slate",
    types: ["developer", "organization"],
    status: "planned",
    needs: "a git-host integration (OAuth + sync)",
  },
];
